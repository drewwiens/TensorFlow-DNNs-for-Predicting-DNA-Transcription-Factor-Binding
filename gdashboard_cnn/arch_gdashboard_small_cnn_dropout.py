    ...
    for dataset_num in range(0, len(_datasets)):
        ...
        while stop_condition is None:
            if i%1000 == 0:
                ...
                print("%s, dataset %g, epoch %d, step %d, time elapsed %g, validation roc auc %g, perc chg in auc %g, conv_keep_prob %g"%(_datasets[dataset_num], dataset_num, _train_epochs_completed, i, time.time()-t0, roc_auc, perc_chg_auc, this_conv_keep_prob))
